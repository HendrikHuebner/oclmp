...
__kernel void oclmp_add(const int n, __global const u8* A, __global const u8* B, 
                        __global u8* C) {
    u32 carry = 0;
...
__kernel void oclmp_combine(const int n, __global const u8* A,  __global const u32* S, __global u8* C) {
    u32 carry = 0;
    ((u32*) C)[0] = ((u32*) A)[0];
